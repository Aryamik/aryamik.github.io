...
If there is one thing that defines humans a society, it is the underlying quest for figuring out the world around us.

make sense of this complex world.

In words of physicist Brian Cox, we bring meaning into otherwise meaningless universe.

We figure stuff out around and that includes labeling stuff around us; organizing things into discrete patterns, group like things with other like things.

Somewhere down the road,

For practical reasons, do we really care about the distinction between what is an art and what is science? No. Every art has a science behind it and every scientific endevour is underpinned by an artistic drive. An artist will try to give his own artistic spin to something that a scientist. We all see the world as we see fit. A piece of art maybe nothing but an amalgam of different colors and pigments that is arranged in a way that is visually appealing to an human eye. On the other hand, someone may interpret random vibrations of strings on a guitar that are transmitting it to an amplifier as a melody. So the question arises, why do we even care?

To that, I will say "you are right. " The distinction between art and science is not something that affects most of our day-to-day lives. It just helps us understand how things works and how.

This is something that has been going for centuries.

That is all. If you think is a new concept,

On February 9, 1498, Leonardo starred in an evening of debates at the Sforza Castle that involved the relative merits of geometry, sculpture, music, painting, and poetry. He gave a rigorous scientific and aesthetic defense of painting, which was then considered a mechanical art, arguing that it should instead be regarded as the highest of the liberal arts, transcending poetry and music and sculpture.
...
what we now consider as 'physics' was considered as philosophy in ancient Greece.

Language keeps changing, people keep changing.

We have other things to worry about like paying our bills,

random enses the vibrations of the strings **electronically** and routes an electronic signal to an amplifier and [speaker](https://electronics.howstuffworks.com/speaker.htm). The sensing occurs in a **magnetic pickup** mounted under the strings on the guitar's body. A simple magnetic pickup looks like this:

It is a spectrum.

Is this something that is going to affect our day-to-day lives? Most porbably not.

At the end of the day, do I really care if

Even today there is so much we do not know.
